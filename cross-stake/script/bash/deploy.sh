...
export GLOBAL_MANAGER_CONTRACT_ADDRESS=$(forge script DeployGlobalManager --broadcast --rpc-url $OMNI_RPC_URL --private-key $PRIVATE_KEY --legacy | grep "Contract Address:" | awk '{ print $3 }')
